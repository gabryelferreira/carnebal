    ...
    <form class="this-is-atendimento marginHeader configPadrao" action="finalizarcomanda" method="POST">
        ...
        <div class="container">
            ...
            <div class="allCaixa comanda-especifica">
                <div class="comanda-especifica-valores">
                    <div class="wrapperThis">
                        <i class="btnVoltarComanda fa fa-arrow-left fa-lg fa-fw"></i>
                        <h1>Valor pago</h1>
                        ...
                        <h1>Troco</h1>
                        <div class="inputWithImg">
                            <input type="text" disabled name="valorTroco" id="valorTroco">
                            <i style="padding: 9px 12px; font-family: Roboto Condensed, sans-serif; font-size: 18px;">R$</i>
                        </div>
                        <div class="btnComandaEspecifica">
                            <a class="btnCarrinho btnFinalizarComanda"><i style="margin: 0 5px 0 0; color: #fff;" class="fa fa-shopping-cart fa-lg fa-fw"></i>Finalizar</a>
                        </div>
                    </div>
                </div>
                <div class="comanda-especifica-direita">
                    ...
                    <div class="comanda-especifica-produtos">
                        ...
                        <?php
                            ...
                            $dadosComanda = ComandaEspecificaController::GetComanda(end($id));
                            $soma = 0;
