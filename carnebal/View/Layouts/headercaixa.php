...
<nav id="menuResponsive" class="menuResponsive">
    <ul>
        <a href="<?php echo BaseUrl::getBaseUrl();?>/atendimento"><li><img src="<?php echo $_SESSION['foto'];?>">Bem vindo(a), <?php echo $_SESSION['nomeFuncionario'];?>!</li></a>
        ...
        <a href="<?php echo BaseUrl::getBaseUrl();?>/comandas"><li><img style="filter: invert(100%);" src="<?php echo BaseUrl::getBaseUrl();?>/View/Contents/img/atendimento.png">Caixa</li></a>
